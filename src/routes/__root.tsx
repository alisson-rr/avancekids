...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Avance Kids — Desenvolvimento infantil com base em ABA" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Avance Kids" },
      { property: "og:title", content: "Avance Kids — Desenvolvimento infantil com base em ABA" },
      {
